...
class CheckForms
{
    ...
    public function addNotes($intBy)
    {
    ...
    public function checkLeadVisited()
    {
...
//All offer functions start
    public function checkOfferCalled()
    {
    ...
    public function checkProspectCalled()
    {
        if (isset($_POST["frmCalledProspect"]) and isset($_GET["id"]))
        {
            $strOption = $_POST["clientstatus"];
    ...
    public function checkAdminAddForm()
    {
    ...
    public function checkFormItem($strName, $strType, $blnNoNumbers = false, $blnNoLetters = false)
    {
        if ($strType == "select")
        {
